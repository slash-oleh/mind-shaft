#!/usr/bin/env bash
# Usage: submit-review.sh <PR_NUMBER> <PAYLOAD_FILE>
...
PR=${1:?Usage: submit-review.sh <PR_NUMBER> <PAYLOAD_FILE>}
PAYLOAD_FILE=${2:?Usage: submit-review.sh <PR_NUMBER> <PAYLOAD_FILE>}
