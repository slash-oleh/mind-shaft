...
- **Separation of Concerns**: The global layout doesn't need to know about the requirements of specific pages.
- **Flexibility**: Pages can easily deviate from the "standard" structure without touching shared code.
- **Maintainability**: Reduces complex conditional logic in shared components.
- **Explicitness**: The structure of a page is visible directly in the page component itself, not hidden in a wrapper.
