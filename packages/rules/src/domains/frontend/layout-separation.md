...
- **Cohesion**: Domain logic remains concentrated in feature modules, while pages remain lightweight and easy to reason about.
- **Maintainability**: You can safely delete or rename a page file without worrying about losing the underlying business logic.
- **Scalability**: Creating a new page (e.g., a "Quick Sign In" modal or a new dashboard variant) is a matter of composing existing features.
