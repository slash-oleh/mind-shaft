...
- **Performance**: Vectors often smaller than equivalent raster assets.
- **Usability**: Sharp graphics at any zoom level.
- **Consistency**: Unified styling and scaling behavior.
