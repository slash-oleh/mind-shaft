...
- **Usability**: Making all options visible reduces the cognitive load required to understand the available choices.
- **Explicitness**: The current state and alternative options are clearly displayed, making the system's state easier to parse at a glance.
