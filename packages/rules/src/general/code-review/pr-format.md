...
- **Consistency**: A uniform PR history is easier to search and navigate.
- **Readability**: Reviewers can immediately grasp the scope and intent of the PR from the title.
