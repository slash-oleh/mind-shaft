...
- **Maintainability**: Ensures that all feedback is tracked and resolved before code reaches the main branch.
- **Readability**: Makes the current state of any PR obvious to anyone looking at the dashboard.
