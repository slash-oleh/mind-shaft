...
- **Scalability**: Adding a new case is as simple as adding a new key-value pair to the map.
- **Declarative**: Describes _what_ to do for each key rather than _how_ to branch to it.
- **Readability**: The relationship between keys and actions is immediately obvious.
- **Maintainability**: Encourages smaller, focused functions and separates selection logic from execution logic.
