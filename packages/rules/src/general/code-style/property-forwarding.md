...
- **Maintainability**: Adding new properties to the source object doesn't require updates to forwarding logic.
- **Readability**: Reduces visual noise by hiding properties that aren't relevant to the current scope.
- **Coupling**: Reduces the dependency of the intermediate code on the full structure of the data object.
- **Size/Code Amount**: Less code to write and maintain.
