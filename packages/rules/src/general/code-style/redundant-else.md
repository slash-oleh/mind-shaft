...
- **Readability**: Reduces cognitive load by keeping the "happy path" aligned with the main function body.
- **Maintainability**: Flat code is easier to refactor and test.
