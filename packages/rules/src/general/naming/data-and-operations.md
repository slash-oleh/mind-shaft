...
- **Readability**: Allows developers to immediately identify whether an identifier is a value or an action.
- **Consistency**: Establishes a logical grammatical structure for the entire codebase.
