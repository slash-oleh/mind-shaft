...
- **Readability**: Precise names allow developers to understand structure and data intent by scanning.
- **Maintainability**: Clear intent makes it obvious where features belong and prevents redundant logic.
- **Consistency**: Prevents visual noise and standardizes how collections and components are named.
