...
- **Integrity**: Prevents users from manipulating the system's security boundaries.
- **Reliability**: Ensures the system remains secure regardless of client-side inspection or tampering.
