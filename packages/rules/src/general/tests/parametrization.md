...
- **Maintainability**: Logic is defined once; changes only need to be made in one place.
- **Readability**: The data table clearly shows the range of cases covered, making the test's intent obvious at a glance.
- **Scalability**: Adding a new test case is as simple as adding another row to the array.
