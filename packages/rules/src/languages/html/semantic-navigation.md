...
- **Usability**: Supports standard browser features like "Open in new tab" and "Back" button navigation.
- **Accessibility**: Screen readers announce links correctly and allow users to see where they are going.
