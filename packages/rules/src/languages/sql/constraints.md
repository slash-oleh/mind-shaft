...
- **Integrity**: Guarantees that relationships between tables remain valid (referential integrity).
- **Consistency**: Ensures that data follows a uniform set of rules across the entire system.
- **Robustness**: Acts as a final layer of defense against application bugs.
- **Reliability**: Prevents the introduction of "ghost" data that can cause runtime crashes.
