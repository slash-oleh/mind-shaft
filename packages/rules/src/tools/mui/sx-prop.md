...
- **Readability**: Styles are co-located with the component, facilitating quick understanding of the UI structure.
- **Maintainability**: Leverages the theme system, making it easy to perform global style updates.
- **Consistency**: Ensures that components use the same spacing and color tokens defined in the project theme.
- **Explicitness**: Dynamic styles are handled directly within the component's render logic, making the intent clear.

## Exceptions

- **Complex Reusable Components**: If a specific set of styles is reused across many instances, a custom `styled` component might be better for **Encapsulation**.
