...
- **KISS**: A flatter structure is easier to manage, scan, and refactor.
- **Readability**: Descriptive filenames (e.g., `Button.tsx`) are much more readable in IDE tabs than generic `index.tsx` files.
