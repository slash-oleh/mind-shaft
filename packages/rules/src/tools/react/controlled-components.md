...
- **Consistency**: Guarantees that the component always reflects the most up-to-date value from its parent.
- **KISS**: Eliminates the maintenance burden of tracking duplicate values and manual synchronization logic.
- **Performance**: Reduces the number of re-renders by eliminating the intermediate "state sync" step.
