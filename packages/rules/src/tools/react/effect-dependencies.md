...
- **Performance**: Prevents expensive or rate-limited side effects from firing unnecessarily.
- **Maintainability**: Clearly separates the _reason_ an effect runs from the _data_ it needs to perform its task.
