...
- **KISS**: Functional components are just functions. They eliminate the confusion of `this` and the boilerplate of classes.
- **Cohesion**: Hooks allow you to group related code by what it's doing (e.g., a subscription) rather than when it's happening (lifecycle).
- **Readability**: Resulting code is shorter and follows a more declarative pattern.
