...
- **Cohesion**: Moves the coordination logic (e.g., "only one expanded") into the component responsible for the whole feature.
- **Flexibility**: Allows the parent to easily add features like "Expand All," "Collapse All," or "Reset State" without modifying the children.
