...
- **Performance**: Stabilizing references is critical for making `React.memo` effective.
- **Robustness**: Sacrificing a small amount of memory for a cache is often the correct architectural decision to ensure a smooth, lag-free UI.
