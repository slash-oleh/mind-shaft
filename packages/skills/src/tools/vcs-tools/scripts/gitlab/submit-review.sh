#!/usr/bin/env bash
# Usage: submit-review.sh <MR_NUMBER> <PAYLOAD_FILE>
...
MR=${1:?Usage: submit-review.sh <MR_NUMBER> <PAYLOAD_FILE>}
PAYLOAD_FILE=${2:?Usage: submit-review.sh <MR_NUMBER> <PAYLOAD_FILE>}
