...
- **[Reliability](../../home/impact/positive/reliability.md)**: Guarantees business continuity after catastrophic failures.
- **[Integrity](../../home/impact/positive/integrity.md)**: Ensures data revertible to known good state after corruption.
- **[Maintainability](../../home/impact/positive/maintainability.md)**: Reduced recovery time objectives (RTO) and recovery point objectives (RPO).
